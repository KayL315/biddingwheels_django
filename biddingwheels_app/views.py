...
def detail_page(request, listid):
    class CarListing:
        def __init__(self, listid, licenseNumber, engineSerialNumber, make, image, model, color, year, mileage, city,
                      additionalFeatures, description, startingPrice, biddingDeadline, highestBid, highestBidHolder, seller):
            self.make = make
            ...
            self.highestBidHolder = highestBidHolder
            self.seller = seller
        ...
        def serialize(self):
            return {
                ...
                "engineSerialNumber": self.engineSerialNumber,
                "mileage": self.mileage,
                "city": self.city,
                "additionalFeatures": self.additionalFeatures,
                "description": self.description,
                "startingPrice": self.startingPrice,
                "biddingDeadline": self.biddingDeadline,
                "highestBid": self.highestBid,
                "highestBidHolder": self.highestBidHolder,
                "make": self.make,
                "image": self.image,
                "model": self.model,
                "color": self.color,
